...
function EmojiPoint({ point }: { point: string }) {
  ...
  return (
    <MotionDiv
      ...
      className="group relative bg-linear-to-br from-gray-200/[0.08] to-gray-200/[0.03] p-4 rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all duration-300"
    >
